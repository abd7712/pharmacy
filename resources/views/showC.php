...
<div class="container">
    ...
    if ($drugs->isEmpty()) {
        ...
        foreach ($drugs as $drug) {
            ...
            // زر عرض الوصف
            echo '<a href="/descriptionC/'.$drug->id.'/'.$user->id.'" class="btn btn-view">View Description</a>';
            //زر الشراء
            echo '<a href="/buy/'.$drug->id.'/'.$user->id.'" class="btn btn-edit">Buy</a>';
            //زر اضافة
            echo '<a href="#" class="btn btn-delete">Add To Cart</a>';
            echo '</li>';
        }
        echo '</ul>';
    }
...
<a href="/" class="btn btn-admin">Back to Homepage</a>
